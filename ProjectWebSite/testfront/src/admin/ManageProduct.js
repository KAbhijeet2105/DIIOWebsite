...
import { createProduct, getProductById, updateProduct } from './helper/adminapicall';
    ...
    getProductById(productId).then(data => {
       if(data.error)
       {
        ...
        setValues({...values,
            ...
            prod_usrname:data.prod_usrname,
            prod_usremail:data.mobileNumber,
            prodTitle:data.prodTitle,
            prodImg:data.prodImg,
            prodDesc:data.prodDesc,
            prodLink:data.prodLink,
...
const handleChange = name => event => {
 ...
 const onSubmit = (event) => {
  ...
  updateProduct(match.params.productId,values)
  .then(data => {
    if(data.error){
      setValues({...values,error:data.error});
    }
  ...
  return (
     ...
     <div className="container bg-white">
       <div className="jumbotron bg-white text-dark center">
         <h2 className="display-4 ">Update your Product</h2>
    ...
    <form class="col s12">
      <div class="row">
        ...
        <div class="input-field col s6 ">
          ...
          <label class="active" for="prod_usrname">User Name</label>
        </div>
        {/* email id */}
        <div class="input-field col s6 ">
          <input disabled id="prod_usremail" type="email"   value={prod_usremail}/>
          <label class="active" for="prod_usremail">Email</label>
        </div>
      </div>
      {/* Product Name */}
      <div class="row">
        ...
        <i class="material-icons prefix">switch_account</i>
          ...
          <label class="active" for="prodTitle">Product Name </label>
        </div>
    </div>
 ...
 {/* product description  */}
      <div class="row">
        ...
        <i class="material-icons prefix">add_location</i>
          ...
          <label class="active" for="prodDesc">Product description</label>
        </div>
      </div>
...
<div class="file-field input-field col s12 form-group">
   ...
   <div class="row">
        ...
        <i class="material-icons prefix">linkedin</i>
          ...
          <label class="active" for="prodLink">Product Buying Link</label>
        </div>
    </div>
...
{isAuthenticated() &&  <button onClick={onSubmit} class="btn green waves-effect waves-light btn-large " type="submit" >Update Product
